...
var KMeansPlus = require("./kmeans-plus");
...
KMeans.prototype.clusterPlus = function(points, k, distance) {
    let kmeansPlus = new KMeansPlus(points, k, distance);
	this.centroids = kmeansPlus.getCentroids();

    return this.cluster.apply(this, arguments);
};
